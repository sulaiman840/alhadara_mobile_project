...
class EditQuestionDialog extends StatefulWidget {
  ...
  const EditQuestionDialog({super.key, required this.initialText});
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: AlertDialog(
        ...
        title: Text(
          context.trf('forum_edit_question_title',
              ar: 'تعديل السؤال', en: 'Edit question'),
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            labelText:
            context.trf('forum_content', ar: 'المحتوى', en: 'Content'),
